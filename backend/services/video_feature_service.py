...
from services.stimulus_timeline import STIMULUS_TIMELINE, get_phase_at, timeline_as_dicts
...
def extract_video_features(video_path: str, session_id: str, output_dir: str | None = None) -> dict[str, Any]:
    ...
    return {"session_id": session_id, "output_dir": output_dir, "frame_features_path": frame_path, "phase_features_path": phase_path, "session_features_path": session_csv_path, "session_features_json_path": session_json_path, "stimulus_timeline_path": timeline_path, "frame_preview": frame_df.head(120).replace({np.nan: None}).to_dict("records"), "quality": quality_assessment, "session_features": session_features}
